...
- Repo: https://github.com/dreamsofcode-io/guestbook
...
- Repo: https://github.com/JamesTurland/JimsGarage/tree/main/Traefikv3
- https://www.youtube.com/watch?v=mZbLvGQqEvY - Andrew Schmelyun, Manage multiple sites with Docker and Traefik
- Repo: https://github.com/aschmelyun/docker-compose-traefik

## Installation (Local development and VPS server)

**Note!** Always use the latest instructions from Docker: https://docs.docker.com/compose/install/linux/
